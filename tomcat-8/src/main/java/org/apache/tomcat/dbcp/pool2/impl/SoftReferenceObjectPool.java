...
/**
 * A {@link SoftReference SoftReference} based
...
public class SoftReferenceObjectPool<T> extends BaseObjectPool<T> {
	 ...
	 * <p>
	 * All instances are
	 * {@link PooledObjectFactory#activateObject( org.apache.tomcat.dbcp.pool2.PooledObject)
	 * activated} and
	 * {@link PooledObjectFactory#validateObject( org.apache.tomcat.dbcp.pool2.PooledObject)
	 ...
	 * failing instance is
	 * {@link PooledObjectFactory#destroyObject( org.apache.tomcat.dbcp.pool2.PooledObject)
	...
	public synchronized T borrowObject() throws Exception {
		...
		while (null == obj) {
			if (idleReferences.isEmpty()) {
				...
				obj = ref.getObject();
				// Clear the reference so it will not be queued, but replace
				// with a
				// a new, non-registered reference so we can still track this
				// object
				// in allReferences
	 ...
	 * validation} fails</li>
	 * <li>
	 * {@link PooledObjectFactory#passivateObject( org.apache.tomcat.dbcp.pool2.PooledObject)
	 ...
	 * validated} and
	 * {@link PooledObjectFactory#passivateObject( org.apache.tomcat.dbcp.pool2.PooledObject)
	 * passivated}. If validation fails, the new instance is
	 * {@link PooledObjectFactory#destroyObject( org.apache.tomcat.dbcp.pool2.PooledObject)
	 * destroyed}. Exceptions generated by the factory <code>makeObject</code>
	 * or <code>passivate</code> are propagated to the caller. Exceptions
