...
public class WsSession implements Session {
    ...
    private volatile Whole<PongMessage> pongMessageHandler = null;
        ...
        for (MessageHandlerResult mhResult : mhResults) {
            switch (mhResult.getType()) {
                ...
                case PONG: {
                    ...
                    if (handler instanceof Whole<?>) {
                        pongMessageHandler =
                                (Whole<PongMessage>) handler;
                    } else {
                        throw new IllegalStateException(
    ...
    protected Whole<PongMessage> getPongMessageHandler() {
