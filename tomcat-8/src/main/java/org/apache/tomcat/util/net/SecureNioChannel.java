...
public class SecureNioChannel extends NioChannel {
	 ...
	 *
	 * @param block
	 *            Should a blocking write be used?
	 * @param s
	 * @param timeout
	 ...
	 * both network and application buffers have been emptied out prior to this
	 * call taking place, or a IOException will be thrown.
	 * 
	 * @param timeout
	 *            - timeout in milliseconds for each socket operation
	 * @throws IOException
	 *             - if an IO exception occurs or if application or network
