...
public class JspRuntimeLibrary {
	...
	protected static class PrivilegedIntrospectHelper implements PrivilegedExceptionAction<Void> {
		...
		PrivilegedIntrospectHelper(Object bean, String prop, String value, ServletRequest request, String param,
	...
	public static void introspecthelper(Object bean, String prop, String value, ServletRequest request, String param,
		...
		if (Constants.IS_SECURITY_ENABLED) {
			try {
				PrivilegedIntrospectHelper dp = new PrivilegedIntrospectHelper(bean, prop, value, request, param,
						ignoreMethodNF);
	...
	private static void internalIntrospecthelper(Object bean, String prop, String value, ServletRequest request,
