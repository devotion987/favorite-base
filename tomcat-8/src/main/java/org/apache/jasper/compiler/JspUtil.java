...
public class JspUtil {
	 ...
	 * done by Boolean.parseBoolean(s), the value "yes" (ignore case) is also
	...
	static InputStreamReader getReader(String fname, String encoding, Jar jar, JspCompilationContext ctxt,
