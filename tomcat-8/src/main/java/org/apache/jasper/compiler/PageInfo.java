...
class PageInfo {
	...
	/**
	 * Check if the plugin ID has been previously declared. Make a not that this
	 * Id is now declared.
	 * 
	 ...
	 * @param uri The URI to map
	 *
	 * @return true if the given URI is mapped to a tag library, false otherwise
	 */
	...
	/*
	 * Pushes the given URI onto the stack of URIs to which the given prefix is
	 * mapped.
	 *
	...
	/*
	 * Removes the URI at the top of the stack of URIs to which the given prefix
	 * is mapped.
	 *
	 ...
	 *
	 * @param useDefault
	 *            TRUE if the default (org.apache.jasper.runtime.HttpJspBase)
	 *            should be returned if this attribute has not been set, FALSE
	 *            otherwise
	 *
	 * @return The value of the 'extends' page directive attribute, or the
	 *         default (org.apache.jasper.runtime.HttpJspBase) if this attribute
	 *         has not been set and useDefault is TRUE
	 */
