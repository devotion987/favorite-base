...
/**
 * Helper JavaBean for JSPs, because JSTL 1.1/EL 2.0 is too dumb to to what I
 * need (call methods with parameters), or I am too dumb to use it correctly. :)
 * 
...
public class JspHelper {
	 ...
	 * NOTE: this method has explicit support for Tapestry 3 and Struts 1.x
	 *
	 * @param in_session
	 *            Session from which the locale should be guessed
	 *
	 * @return String
	 */
