...
/**
 * Helper class used to initialize and populate the JNDI context associated with
 * each context and server.
 *
...
public class NamingContextListener implements LifecycleListener, ContainerListener, PropertyChangeListener {
	...
	/**
	 * Acknowledge the occurrence of the specified event. Note: Will never be
	 * called when the listener is associated to a Server, since it is not a
	 * Container.
	 *
	 * @param event
	 ...
	 * @param oldValue
	 *            The old value (or <code>null</code> if adding)
	 * @param newValue
	 *            The new value (or <code>null</code> if removing)
	 */
	...
	public void addService(ContextService service) {
		...
		Reference ref = new ServiceRef(service.getName(), service.getType(), service.getServiceqname(),
	...
	public void addResource(ContextResource resource) {
		...
		// Create a reference to the resource.
		Reference ref = new ResourceRef(resource.getType(), resource.getDescription(), resource.getScope(),
