 ...
 * environment with the common class loader environment set up by Catalina. This
 * should be executed from a command line script that conforms to the following
 * requirements:
 * </p>
 * <ul>
 * <li>Passes the <code>catalina.home</code> system property configured with the
 * pathname of the Tomcat installation directory.</li>
 ...
 * <ul>
 * <li><em>-ant</em> : Set the <code>ant.home</code> system property to
 * corresponding to the value of <code>catalina.home</code> (useful when your
 * command line tool runs Ant).</li>
