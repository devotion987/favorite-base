...
import com.wugy.java.utils.FileUtil;
import com.wugy.java.utils.StreamUtil;
import com.wugy.spring.annotation.mvc.entity.Multipart;
import com.wugy.spring.annotation.mvc.entity.Multiparts;
import com.wugy.spring.annotation.mvc.entity.Params;
import com.wugy.spring.annotation.mvc.error.UploadException;
...
public class UploadHelper {
	...
	public static void init(ServletContext servletContext) {
		...
		if (uploadLimit != 0) {
			// 单位为M
			fileUpload.setFileSizeMax(uploadLimit * CustomConst.bufSize * CustomConst.bufSize);
		}
	}
	...
	public static List<Object> createMultipartParamList(HttpServletRequest request) throws Exception {
		...
		for (FileItem fileItem : fileItemList) {
			...
			if (fileItem.isFormField()) {
				// 处理普通字段
				String fieldValue = fileItem.getString(CustomConst.UTF_8);
