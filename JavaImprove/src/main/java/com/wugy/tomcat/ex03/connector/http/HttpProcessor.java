...
import com.wugy.tomcat.ex03.ServletProcessor;
import com.wugy.tomcat.ex03.StaticResourceProcessor;
...
public class HttpProcessor {
	 ...
	 */
	protected StringManager sm = StringManager.getManager(ConsTomcat.packageEx03);
	...
	public void process(Socket socket) {
		...
		try {
			input = new SocketInputStream(socket.getInputStream(), ConsTomcat.size);
