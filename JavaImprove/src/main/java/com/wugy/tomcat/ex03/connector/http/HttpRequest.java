...
import com.wugy.tomcat.ex03.connector.RequestStream;

public class HttpRequest extends AbsHttpServletRequest {
	 ...
	 */
	protected static List<Object> empty = new ArrayList<>();
	/**
	...
	protected void parseParameters() {
		...
		if ("POST".equals(getMethod()) && (contentLen > 0) && "application/x-www-form-urlencoded".equals(contentType)) {
			try {
				int max = contentLen;
				int len = 0;
	...
	public void setContextPath(String path) {
		this.contextPath = null == path ? "" : path;
	}
	...
	public static List<Object> getEmpty() {
		return empty;
	}
