...
public class FileUtil {
	...
	public static final byte[] readFileAsByteArray(String path) {
		...
		try {
			...
			CloseUtil.closeInputStream(fileInStream);
		}
		return data;
	}
	 ...
	 * @throws Exception
	 */
	public static final void writeByteArrayToFile(String path, byte[] data) {
		File file = new File(path);
		...
		try {
			...
			CloseUtil.closeOutputStream(fileOutStream);
		}
	}
	...
	public static void writeFile(String filePath, String fileContent) {
		...
		try {
			...
			w = new OutputStreamWriter(os, CustomConst.UTF_8);
			w.write(fileContent);
			w.flush();
		} catch (Exception e) {
			e.printStackTrace();
